...
- Lane-based waves: 0–9 production-verified; **SITE_DESIGN_v2 approved** — Waves 11–14 shipped on `main`. **Next:** Wave 15 UI readiness → Wave 16 content supply (L12) → Wave 17 newsletter pilot → Wave 18 member-independent features → Wave 19+ scale (credits ≥50 users).
