 ...
 * deadlocked with PRs accumulating for days. (Same class of bug that
 * deadlocked orbita 2026-08-09; this file had not received the fix. This
 * project was paused at the time for an unrelated founder review, so the bug
 * never had a chance to bite here — worth knowing before resuming.)
 *
 * @param {OpenPR} pr
