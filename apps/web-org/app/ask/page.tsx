...
export const metadata: Metadata = {
  title: 'Ask',
  description: 'Ask the companion for Harvest Hub guidance, or leave a message for the community team.',
};
...
export default function AskPage() {
  return (
    <PageShell width="wide">
      <PageIntro
        title="Ask"
        description="Start with the companion for immediate guidance. Leave a message below if you prefer a human follow-up."
      />
