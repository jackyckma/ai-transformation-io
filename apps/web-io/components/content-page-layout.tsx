...
export function ContentPageLayout({
  ...
  return (
    <PageShell as="article">
      ...
      <PageIntro
        eyebrow={PILLAR_LABEL[doc.pillar]}
        title={doc.title}
        description={doc.description}
      />
      <OpenInAsk contextId={doc.slug} actions={libraryAskActions(doc.title)} className="mb-3" />
      <ExternalAgentLinks title={doc.title} path={doc.pathname} className="mb-8" />
