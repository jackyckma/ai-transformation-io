...
const MENU_LINKS: MenuLink[] = [
  { href: '/settings', label: 'Settings', description: 'Onboarding profile and preferences' },
  { href: '/progress', label: 'Your progress', description: 'Saved assessment when signed in' },
  {
    href: '/for-agents',
    label: 'Agentic access API',
    description: 'Read and contribute via the agent API',
  },
  { href: '/api/agent', label: 'Agent entry', external: true },
  { href: 'https://ai-transformation.org', label: 'Community on .org', external: true },
];
          ...
          <>
            ...
            >
              <div className="flex h-full flex-col overflow-y-auto p-5 pt-[max(1.25rem,env(safe-area-inset-top))]">
                ...
                <p className="mt-8 text-xs font-normal uppercase tracking-[0.12em] text-[var(--secondary)]">
                  Menu
                </p>
